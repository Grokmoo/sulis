...
function apply_effect(parent, ability, target)
  ...
  local amount = 4 + stats.caster_level / 4 + stats.perception_bonus / 4
  ...
  anim:set_color(anim:param(0.0), anim:param(0.2), anim:param(1.0), anim:param(0.5))
