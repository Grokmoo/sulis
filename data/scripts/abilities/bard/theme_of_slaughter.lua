MELODY_NAME = "theme_of_slaughter"
...
function on_entered(parent, ability, targets)
  ...
  local bonus = (10 + stats.caster_level / 2 + stats.perception_bonus / 2) * 0.025
  effect:add_num_bonus("crit_chance", 4 + stats.caster_level / 4 + stats.perception_bonus / 2)
  effect:add_num_bonus("crit_multiplier", bonus)
