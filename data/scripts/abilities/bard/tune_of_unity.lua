...
function on_entered(parent, ability, targets)
  ...
  effect:add_num_bonus("flanking_angle", bonus * 2)
  effect:add_num_bonus("concealment_ignore", bonus)
  effect:add_num_bonus("initiative", bonus / 2)
