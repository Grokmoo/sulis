...
function on_target_select(parent, ability, targets)
  ...
  local min_dmg = 2 + stats.caster_level / 6 + stats.intellect_bonus / 12
  local max_dmg = 4 + stats.caster_level / 3 + stats.intellect_bonus / 6
  effect:add_damage_of_kind(min_dmg, max_dmg, "Raw")
