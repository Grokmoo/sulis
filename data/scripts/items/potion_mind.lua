function on_activate(parent, item)
  ...
  effect:add_attribute_bonus("Intellect", 3)
  effect:add_attribute_bonus("Perception", 3)
  effect:add_attribute_bonus("Wisdom", 3)
  ...
  anim:set_color(anim:param(0.0), anim:param(1.0), anim:param(0.0))
